...
import InputRequest4 from "./InputRequest4";
...
function InputRequest1(props) {
  ...
  const addDocument = async () => {
    try {
      ...
      axios.post("document", getFormData(object), {
        headers: {
  ...
  const onChangeSub = (event) => {
    ...
    {
      event.target.value === "" && setSubjectId("");
    }
  };

  const sec1Change = (event) => {
  ...
  const [documant, setDocument] = useState("ขอลงทะเบียนเรียนเพิ่ม");
              ...
              <div className="w-[90%]  justify-self-center p-[30px] ml-[6%] m-[4%] ">
                ...
                <div className="text-sm my-[2vh]">
                  <label className="">
                    ...
                    {documant}ในรายวิชา 0{subjectId} {subjectInput} กลุ่มการเรียน{" "}
                    {sec1}
                    &emsp;เนื่องจาก
                    {title}
                  </label>
            ...
            <div className="grid my-[2vh] ">
              <div className="flex justify-self-end mr-[5%]">
                ...
                <button
                  ...
                  onClick={() =>
                    moment().format("Do MMM YYYY, LT") & setState("2") & setCurrentStep(4) & addDocument()
                  }
                >
                  ยืนยัน
                </button>
            ...
            <div className="flex justify-center">
              <div className="bg-gray-100 rounded-2xl w-[70%] ml-[6%] my-[3%] p-[30px] text-xl font-semibold ">
                ...
                <div className="grid grid-cols-12 my-[20px]">
                  <div className="col-span-6 ">
                    รหัสวิชา&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                    <label className="font-medium">0{subjectId}</label>
                  </div>
                  <div className="col-span-6  ">
                    <label className="">
                      วิชา&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                      <label className="font-medium">{subjectInput}</label>
                    </label>
                  </div>
                </div>
                <div className="my-[20px]">
                  <label>
                    กลุ่มการเรียน&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                    <label className="font-medium">{sec1}</label>
                  </label>
                </div>
                <div className="my-[20px]">
                  <label>
              ...
              {fileUpload !== null && (
                ...
                {/* {fileUpload !== "null" && (
                            <div className="flex my-[20px]">
                              ...
                              <button
                                onClick={() => download(fileUpload.name)}
                              >
                                {fileUpload.name}
                              </button>
                            </div>
  ...
  return (
    <div>
      {(documant === "ขอลงทะเบียนเรียนเพิ่ม") & (state == "0") ? (
        <div>
            ...
            <div className="text-lg font-font-medium text-gray-600">
              <div className="search-container">
                <div className="search-inner">
                  <input
                    className="border-2 rounded-2xl border-black-500 p-[10px] pb-[0px]mb-[2vh] w-[60vh] "
                    type="text"
                    value={subjectInput}
                    onChange={onChangeSub}
                  />
                  {/* <button onClick={() => onSearch(subjectInput)}> Search </button> */}
                </div>
                <div className="bg-[#fff] flex flex-col border-2 border-gray	empty:border-none">
                  {subject
                    .filter((item) => {
                      const searchTerm = subjectInput.toLowerCase();
                      const fullName = item.SubjectName
          ...
          {subjectId === "" ? null : (
            <div>
              <div className="flex ml-[10%] mt-[2vh]">
                <div className="w-[36vh] mt-[5px]">
                  <label className="text-xl font-semibold text-gray-600 mb-[2vh]">
                    รหัสวิชา
                  </label>
                </div>
                <div className="p-[10px] mb-[2vh] w-[50vh] text-lg font-font-medium text-gray-600">
                  <label className="">0{subjectId}</label>
                </div>
              </div>
              <div className="flex ml-[10%]">
                <div className="w-[36vh] mt-[5px]">
                ...
                <div className="p-[10px] mb-[2vh] w-[50vh] text-lg font-font-medium text-gray-600">
                  <label className="">{teacherName}</label>
                </div>
              </div>
            </div>
          )}
...
export default connect(mapStateToProps)(InputRequest1);

// {(documant === "ขอลงทะเบียนเพิ่ม") & (state == "0") ? (
//   <div>
//     <div className="grid grid-cols-12 ml-[10%] mt-[5%] mb-[2vh]">
//       <div className="col-span-3 mt-[5px]">
...
//       </div>
//       <div className="p-[10px] mb-[2vh] w-[50vh] text-lg font-font-medium text-gray-600">
//         <label className="">{subjectId}</label>
//       </div>
//     </div>
//     <div className="flex ml-[10%]">
//       <div className="w-[36vh] mt-[5px]">
