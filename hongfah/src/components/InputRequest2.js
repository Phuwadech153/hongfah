...
function InputRequest2(props) {
  ...
  const [documant, setDocument] = useState("ขอย้ายกลุ่มการเรียน");
              ...
              <div className="w-[90%]  justify-self-center p-[30px] ml-[6%] m-[4%] ">
                ...
                <div className="text-sm my-[2vh]">
                  <label className="">
                    ...
                    {documant}จากกลุ่ม {sec1} ไปยังกลุ่ม {sec2}&emsp;เนื่องจาก
                    {title}
                  </label>
                </div>
                <div className="text-sm my-[2vh]">
  ...
  return (
    <div>
      {(documant === "ขอย้ายกลุ่มการเรียน") & (state == "0") ? (
        <div>
...
export default connect(mapStateToProps)(InputRequest2);
