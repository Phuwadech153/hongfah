...
function InputRequest3(props) {
  ...
  const addDocument = async () => {
    try {
      ...
      const object = {
        ...
        Sec1:props.posts[0].user.user.Field,
        Sec2:sec2,
        PayIn:"",
        StatusDoc1:time 
      };
  ...
  const [documant, setDocument] = useState("ขอย้ายแขนงวิชา");
              ...
              <div className="w-[90%]  justify-self-center p-[30px] ml-[6%] m-[4%] ">
                ...
                <div className="text-sm my-[2vh]">
                  <label className="">
                    ...
                    ขออนุมัติย้ายแขนงวิชาเรียนจาก {props.posts[0].user.user.Field} ขอย้ายไปแขนง {sec2}
                    &emsp;เนื่องจาก
                    {title}
                  </label>
                </div>
            ...
            <div className="grid my-[2vh] ">
              <div className="flex justify-self-end mr-[5%]">
                ...
                <button
                  ...
                  onClick={() =>  moment().format("Do MMM YYYY, LT") & setState("2") & setCurrentStep(4) & setSec2("") & addDocument()}
                >
                  ยืนยัน
                </button>
              </div>
  ...
  return (
    <div>
      {(documant === "ขอย้ายแขนงวิชา") & (state == "0") ? (
        <div>
          ...
          <div className="flex ml-[10%] mt-[3vh]">
            ...
            <div className="flex mb-[2vh]">
              {/* <input
            className="border-2 rounded-2xl border-black-500 p-[10px] mb-[2vh] w-[15vh] text-lg font-font-medium text-gray-600"
            type="text"
            placeholder=""
          /> */}
              <div className="relative lg:max-w-sm rounded-full ">
                <div className=" p-[10px]  px-[30px]  text-gray-500 bg-white border rounded-2xl shadow-sm outline-none appearance-none focus:border-indigo-600 text-lg font-font-medium text-gray-600">
                  <label>{props.posts[0].user.user.Field}</label>
                </div>
              </div>
              <div className="text-xl font-semibold text-gray-600 m-[10px] ">
                <label>ไปยัง</label>
              </div>
              <div className="relative w-[full] lg:max-w-sm rounded-full ">
                <select
                  className=" p-[10px] px-[30px] text-gray-500 bg-white border rounded-2xl shadow-sm outline-none appearance-none focus:border-indigo-600 text-lg font-font-medium text-gray-600"
                  onChange={(e) => sec2Change(e)}
                  value={sec2}
                >
                  <option value="วิศวกรรมซอฟต์แวร์">วิศวกรรมซอฟต์แวร์</option>
                  <option value="การพัฒนาสื่อประสมและเกม">
                    การพัฒนาสื่อประสมและเกม
                  </option>
                  <option value="เทคโนโลยีเครือข่ายและระบบ">
...
export default connect(mapStateToProps)(InputRequest3);
