...
function InputRequest5(props) {
  ...
  const [documant, setDocument] = useState("ขอความอนุเคราะห์เปิดวิชาเรียน");
              ...
              <div className="w-[90%]  justify-self-center p-[30px] ml-[6%] m-[4%] ">
                ...
                <div className="text-sm my-[2vh]">
                  <label className="">
                    ...
                    {documant} ภาคการศึกษาพิเศษ ในรายวิชา 0{subjectId}{" "}
                    {subjectInput} เนื่องจาก
                    {title}
                  </label>
                </div>
                <div className="text-sm my-[2vh]">
  ...
  return (
    <div>
      {(documant === "ขอความอนุเคราะห์เปิดวิชาเรียน") & (state == "0") ? (
        <div>
...
export default connect(mapStateToProps)(InputRequest5);
