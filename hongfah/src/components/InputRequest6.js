...
function InputRequest6(props) {
  ...
  const [documant, setDocument] = useState("ขอชำระเงินล่าช้า");
          ...
          <div>
            ...
            <div ref={ref}>
              <div className="w-[90%]  justify-self-center p-[30px] ml-[6%] m-[4%] ">
                ...
                <div className="text-sm my-[2vh]">
                  <label className="">
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;มีความประสงค์...ขออนุมัติชำระค่าธรรมเนียมการศึกษาล่าช้าเป็นกรณีพิเศษ
                    เนื่องจาก
                    {title} และพร้อมชำระค่าธรรมเนียมการศึกษา ภายในวันที่{" "}
                    {paydate}
                  </label>
                </div>
                <div className="text-sm my-[2vh]">
          ...
          <div>
            ...
            <div className="bg-gray-100 rounded-2xl w-[70%] ml-[6%] my-[3%] p-[30px] text-xl font-semibold ">
              ...
              <div className="my-[20px]">
                <label>
                  ชำระภายในวันที่&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;
                  <label className="font-medium">{paydate}</label>
                </label>
              </div>
  ...
  return (
    <div>
      {(documant === "ขอชำระเงินล่าช้า") & (state == "0") ? (
        <div>
          ...
          <div className="flex ml-[10%]">
            ...
            <div className=" mb-[2vh] w-[50vh] text-lg font-font-medium text-gray-600">
              <input
                className="border-2 rounded-2xl border-black-500 p-[10px]  w-[50vh]"
                type="date"
                placeholder=""
                onChange={pay}
                value={paydate}
...
export default connect(mapStateToProps)(InputRequest6);
